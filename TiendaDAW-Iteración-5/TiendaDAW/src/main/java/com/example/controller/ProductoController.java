...
public class ProductoController implements Serializable {
    ...
    public List<Producto> getOfertas() {
        return pDAO.buscaOfertas();
    }

    public List<Producto> getUltimasUnidades() {
        return pDAO.buscaUlt();
    }
    ...
    public void crea() throws IOException {
        if (pDAO.buscaById(producto.getId()) != null) {
            ...
            String rutaAux=producto.getRuta();
            producto.setRuta("./resources/images/"+rutaAux);
